#include "cube2x2.hpp"
    ...
    std::vector<Cubelet> initializeCubelets() {
        ...
        // Кубик 0
        cubelets[0].colors = {colors[0], colors[1], colors[2], sf::Color::Black, sf::Color::Black, sf::Color::Black}; //FRONT, BACK, UP
        cubelets[0].initialPosition = {-offset, offset, offset}; //LEFT, UP, FRONT
